...
include 'helpers.php';
?>
                    <img  src="<?php echo get_base_url(); ?>/src/back_end/<?php echo $post['user_image']; ?>" width="400" height="200" alt="House Image">
...
include 'helpers.php';
?>
                    <img src="<?php echo get_base_url(); ?>/src/back_end/<?php echo $post['house_picture']; ?>" alt="House Image">
                </li>
            </ul>
        </div>
        <?php endforeach; ?>
